 ...
 */
/**
 * This Class creates and implements a max priority queue
 *
...
{
    private E[] items; //initialize
    private static final int INITIAL_SIZE = 10; // create a constant variable for size of array
